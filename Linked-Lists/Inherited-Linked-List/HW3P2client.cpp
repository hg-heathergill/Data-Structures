...
//Purpose of the program:  To be able to extend the linked list class to allow additional functionality through
//inheritance. 
//Algorithm: The program will go through 2 test cases, testing all the fuctions
...
{ slist L;  // the list 
  ...
  try
  {
    ...
    // 11) replace postion 7 with 10
      cout << "Step " << counter << " replace pos 7" << endl; counter++;
        L.replace(10,7);
